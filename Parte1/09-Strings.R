...
# Formatando a saída
sprintf("%s governa os EUA há %d anos", "Barack", 8)
...
# Dividingo uma string em caracteres
...
string1 <- c("Esta é a primeira parte da minha string, legal né?",
             "O que você achou disso? Me responda")

string2 <- c("Precisamos testar outras string - A$!D@",
             "Análisde de Dados em R")
...
# Localiza a primeira e ultima posição em que o caractere aparece
...
# Importanto arquivo txt %%%% COM ERRO, ME AJUDA? kkkkk
