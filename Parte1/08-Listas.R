...
# Lista de Floats
lista_numerico = list(1.90, 45.3, 999.4)
lista_numerico

# Lista de Números Complexos
lista_complexos = list(3.2+3i)
lista_complexos

# Lista de valores lógicos
lista_logicos = list(TRUE, FALSE, TRUE, TRUE)
lista_logicos
...
# Podemos extrair um elemento específico dentro de cada nível
lista1$caracteres[2]
